...
/**
 * It returns a Box component with a bunch of styleSheet props, which contains another Box component
 * with a bunch of styleSheet props, which contains an Image component with a bunch of styleSheet
 * props.
 * @returns A Box component with a Box component inside of it.
 */
function SideImage() {
  return (
    <Box
...
export default function HomeScreen() {
  return (
    <Box>
      <Head >
        <title>Home Screen - Alura Cases Campanha</title>
      </Head>
      <Box
        as="main"
        styleSheet={{
